...
export default function Projects(props: Props) {
  ...
  return (
    <section id="projects" className="py-base px-base bg-gray-100 dark:bg-gray-900">
          ...
          <div className="col-span-3 flex flex-col gap-8">
            ...
            <div className="flex items-center gap-4">
              ...
              <a className="border-4 rounded-full p-3 flex justify-center items-center">
                <GitHub className="hover:text-primary hover:scale-105 transition-all duration-300 ease-linear text-green-400 dark:text-green-200 dark:hover:text-primary font-black"/>
              </a>
            </Link>
            </div>
          </div>
