...
export default function Projects() {
  return (
    <Element name="projects">
      <section className="px-base py-base flex flex-col gap-10 bg-gray-100 dark:bg-gray-900 lg:gap-16">
        {/* Heading */}
        ...
        <div className="flex flex-col gap-20 md:gap-20">
          ...
          {projects.map((project, i) => (
            <article
              key={i}
              className="grid grid-cols-1 gap-5 lg:grid-cols-8 lg:gap-20 xl:p-10"
            >
              {/* Content */}
